...
const pickUpIcon = new L.DivIcon({
  html: `<div style="display:flex; flex-direction:column; align-items: center; filter:drop-shadow(0 4px 12px rgba(0, 0, 0, 0.28)">
            ...
            <div style="width:10px; height: 10px; background: #0a0a0a; border-radius:50%; border:3px solid #fff; 
...
const driverIcon = new L.DivIcon({
  html: `<div id="car-marker"
            style="width:52px; height:52px; display:flex; align-items:center; justify-content:center; transform-origin:center; transition: transform 0.3s cubic-bezier(0.34, 1.56, 0.64,1); filter: drop-shadow(0 6px 18px rgba(0,0,0,0.5));">
            <div style="
  ...
  return (
    <div className="relative h-full w-full bg-zinc-100">
      ...
      >
        ...
        {showPickUpRoute && (
          <Polyline positions={routeToPickUp} pathOptions={{ color: "#888", weight: 4, dashArray: "2 10", lineJoin: "round" }}/>
        )}
