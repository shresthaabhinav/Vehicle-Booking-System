...
export default function CompletedScreen({booking, role}:{booking:any, role:string}) {
    ...
    <motion.div
      ...
      <div className='flex-1 flex flex-col items-center justify-center px-6 py-12'>
        ...
        >
            ...
            <p className='text-zinc-500 text-sm text-center mb-8'>{role=="driver"?"You have successfully dropped the customer.":"You have been dropped by driver"}</p>
            ...
            <div className='bg-zinc-900 border border-zinc-800 rounded-2xl p-5 mb-3'>
                ...
                <p className='text-white text-5xl font-black flex items-center justify-center gap-1 mb-4'><TbCurrencyRupeeNepalese size={30} strokeWidth={2.5}/> {booking.fare}</p>
