...
type docsType = "citizenship" | "license" | "rc"
...
export default function page() {
  ...
  const isCompleted = docs.citizenship && docs.license && docs.rc
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="mt-8 space-y-5">
          ...
          >
            ...
            <input
              ...
              accept="image/*,.pdf"
              onChange={(e) =>
                handleImage("citizenship", e.target?.files?.[0] || null)
              }
            />
          </motion.label>
        ...
        <div className="mt-6 flex items-start gap-3 text-xs text-gray-500">
          ...
          <p>
            Documents are securely stored and mannually verified by our team.
          </p>
        </div>
